...
public class HouseInfoDto {
	...
	private int recnetPrice;
	private List<HouseDealDto> houseDeals;

	public List<HouseDealDto> getHouseDeals() {
		return houseDeals;
	}

	public void setHouseDeals(List<HouseDealDto> houseDeals) {
	...
	public int getRecnetPrice() {
		return recnetPrice;
	}

	public void setRecnetPrice(int recnetPrice) {
		this.recnetPrice = recnetPrice;
	}
